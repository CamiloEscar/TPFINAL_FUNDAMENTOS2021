		...
		Case opcion of
			'1': begin // Alta de dueño
					repeat
						clrscr;
						abrir_archivo_per (archivo_per); 
						cargar_registro_per (registro_per,dni,aux_provincia,ubicacion); // Carga los datos de un registro
						if ubicacion<>-1 then // si ya existe muestra los datos
							begin
								mostrar_registro_cargado_I (archivo_per,registro_per,dni,ubicacion); // Procedimiento Para mostrar los datos
			...
			'2': begin // Baja de persona
					...
					gotoxy(7,2); 
					readln (dni);
					busqueda_binaria (archivo_per,dni,ubicacion); // Procedimiento de busqueda binaria
					if ubicacion = -1 then
						begin
							gotoxy(1,24); 
			...
			'3': begin // Modificación de duenio de estancia
					...
					if ubicacion <> -1 then
						begin
							...
							if Ingresar='S' then
								begin
									modificar_registro_per (registro_per,dni,aux_provincia,ubicacion); // Muestra los datos a modificar
								end;
						end;
					cerrar_archivo_per (archivo_per); 
				end;
